    ...
    <div class="pt-[80px] px-[50px]">
        ...
        <div class="mt-28 h-full flex flex-col gap-2.5">
            <a href="{{ route('register') }}"
                class="text-center w-full h-11 bg-[#FECD4C] rounded-[20px] text-white px-4 py-2.5 rounded-2lg transform transition-transform duration-200 ease-in-out hover:scale-105 active:scale-95">
                <b>Daftar</b>
            </a>
            <a href="{{ route('login') }}"
                class="text-center w-full h-11 bg-[#A3A3A3] rounded-[20px] text-white px-4 py-2.5 rounded-2lg transform transition-transform duration-200 ease-in-out hover:scale-105 active:scale-95">
                <b>Masuk</b>
            </a>
        </div>
    </div>
