        ...
        <div class="mt-5">
            <div class="flex gap-2.5">
                <a href="{{ route('chef-profile') }}">
                    <img class="p-0.5 border-2 border-[#FECD4C] rounded-full"
                        src="{{ asset('common/assets/image/chef-juna.png') }}" alt="" width="40px" height="40px">
                </a>
                <img class="p-0.5 border-2 border-[#FECD4C] rounded-full"
                    src="{{ asset('common/assets/image/chef-arnold.png') }}" alt="" width="40px" height="40px">
                <img class="p-0.5 border-2 border-[#FECD4C] rounded-full"
                    src="{{ asset('common/assets/image/detail-recipe-avatar.png') }}" alt="" width="40px"
                    height="40px">
                <img class="p-0.5 border-2 border-[#FECD4C] rounded-full"
                    src="{{ asset('common/assets/image/chef-marinka.png') }}" alt="" width="40px" height="40px">
                <img class="p-0.5 border-2 border-[#FECD4C] rounded-full"
                    src="{{ asset('common/assets/image/chef-a.png') }}" alt="" width="40px" height="40px">
                <img class="p-0.5 border-2 border-[#FECD4C] rounded-full"
                    src="{{ asset('common/assets/image/chef-b.png') }}" alt="" width="40px" height="40px">
                <img class="p-0.5 border-2 border-[#FECD4C] rounded-full"
                    src="{{ asset('common/assets/image/chef-c.png') }}" alt="" width="40px" height="40px">
            </div>
        </div>
